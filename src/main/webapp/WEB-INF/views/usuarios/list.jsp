                ...
                <div class="panel-heading" role="tab" id="heading${contador.index}">  
                    <h4 class="panel-title">
                        ...
                        <div class="pull-right">
                            <a href="<c:url value="<%= URLConstants.USUARIOS_ALTERAR%>" />/${usuario.id}" class="btn-sm btn-info" >Alterar</a>
                            <a href="<c:url value="<%= URLConstants.USUARIOS_REMOVER%>" />/${usuario.id}" class="btn-sm btn-danger" >Remover</a> 
                        </div>
                    </h4>
                </div>
